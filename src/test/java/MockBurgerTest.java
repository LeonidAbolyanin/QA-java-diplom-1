...
public class MockBurgerTest {
    ...
    public void addIngredientTest() {
        ...
        assertEquals("Изменился список ингредиентов", expectedList, actualList);
    }
    ...
    public void removeIngredientTest() {
        ...
        List<Ingredient> actualList = burger.ingredients;
        assertEquals("В списке остались ингредиенты", 0, actualList.size());
    }
    ...
    public void moveIngredientTest() {
        ...
        Mockito.when(ingredient.getName()).thenReturn("GalacticBurger");
        burger.addIngredient(ingredient);
        burger.addIngredient(newIngredient);
        burger.moveIngredient(0, 1);
        String expectedIngredient = "GalacticBurger";
    ...
    public void getPriceBunTest() {
        ...
        assertEquals("Некорректная стоимость", expectedPrice, burger.getPrice(), 0);
    }
